    ...
    function Attendance() {
        ...
        function initializeGrid() {
            $(document).off("click", ".btn-attendance").on("click", ".btn-attendance", function () {
                ...
                var url = domain + "SchoolApp/Student/AddEditAttendance";
            ...
            $(document).off("click", ".btnSearch").on("click", ".btnSearch", function () {
                ...
                $.get(domain+"Students/GetTableData?StartDate=" + $('#FromDate').val() + '&EndDate=' + $('#ToDate').val() + '&StudentId=' + studentId , function (result) {
                    debugger;
