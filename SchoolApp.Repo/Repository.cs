...
namespace SchoolApp.Repo
{
    ...
    {
        internal SchoolAppEntities Context;
        internal IDbSet<TEntity> DbSet;

        public Repository(SchoolAppEntities context)
        {
            Context = context;
        ...
        public virtual void InsertCollection(ICollection<TEntity> entityCollection)
        {
        ...
        //public virtual void SaveBulk(List<TEntity> enityList)
        //{
        //    using (TransactionScope ts = new TransactionScope())
        //    {
        //        try
        //        {
        //            Context.BulkInsert(enityList);
        //            //  Context.SaveChanges();
        //            ts.Complete();
        //        }
        //        catch (Exception ex)
        ...
        //{
        //   var MailMangers =Context.MailMangers.Where(s => s.ID == id);
        //    Delete(MailMangers);
        //}
